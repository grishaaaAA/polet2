"""Есть ли запас над нашим планом на выгрузке организаторов — круг 21 сентября.

Копия из `замеры-24-09/` для круга 24 сентября: убрана вторая
стартовая точка (каширский выездной юго-востока) — разрешения на неё
не было. Логика замера не менялась, изменился день юго-востока.
